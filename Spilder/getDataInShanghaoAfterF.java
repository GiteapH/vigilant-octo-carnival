...
public class getDataInShanghaoAfterF {
    ...
    public static void getHistoryIntoDatabase() throws SQLException {
        ...
        for(String code:allCode){
            ...
            LinkDataBase.addVals(history,"上海全览_后复权","Data","Ccode","Ctime","Cname","Ctype","Copen","Chigh","Clow","Cpreclose","Cvolume","Ctransactions","Mtype","IsGang");
            i++;
        }
        for(String code:allCode_Zhai){
            ...
            LinkDataBase.addVals(history_zhai,"上海全览_后复权","Data","Ccode","Ctime","Cname","Ctype","Copen","Chigh","Clow","Cpreclose","Cvolume","Ctransactions","Mtype","IsGang");
            i++;
        }
        for(String code:allCode_zhi){
            ...
            LinkDataBase.addVals(history_zhi,"上海全览_后复权","Data","Ccode","Ctime","Cname","Ctype","Copen","Chigh","Clow","Cpreclose","Cvolume","Ctransactions","Mtype","IsGang");
            i++;
        }
    }
