...
public class getDataInXiangGang {
    ...
    static List<String> look = new ArrayList<>();
    ...
    public static void getHistoryIntoDatabase() throws SQLException {
        ...
        for(String code:allCode){
            ...
            if(!rep.equals(td[0])){
                look.add(rep);
                LinkDataBase.addVals(history,"香港全览_不复权","Data","Ccode","Ctime","Cname","Ctype","Copen","Chigh","Clow","Cpreclose","Cvolume","Ctransactions","Mtype","IsGang");
            }
            i++;
        }
        for(String code:allCode_zhi){
            String url1 = "https://push2his.eastmoney.com/api/qt/stock/kline/get?secid=124."+code+"&klt=101&fqt=1&lmt=100001&end=20500000&iscca=1&fields1=f1%2Cf2%2Cf3%2Cf4%2Cf5%2Cf6%2Cf7%2Cf8&fields2=f51%2Cf52%2Cf53%2Cf54%2Cf55%2Cf56%2Cf57%2Cf58%2Cf59%2Cf60%2Cf61%2Cf62%2Cf63%2Cf64&ut=f057cbcbce2a86e2866ab8877db1d059&forcect=1";
            String url2 = "https://push2his.eastmoney.com/api/qt/stock/kline/get?secid=125."+code+"&klt=101&fqt=1&lmt=100000&end=20500000&iscca=1&fields1=f1%2Cf2%2Cf3%2Cf4%2Cf5%2Cf6%2Cf7%2Cf8&fields2=f51%2Cf52%2Cf53%2Cf54%2Cf55%2Cf56%2Cf57%2Cf58%2Cf59%2Cf60%2Cf61%2Cf62%2Cf63%2Cf64&ut=f057cbcbce2a86e2866ab8877db1d059&forcect=1";
            List<String[]> history_zhi = new ArrayList<>();
            System.out.println("当前的ip为:"+ ippool.get(ip_idx % size)[0]+"   port:"+ ippool.get(ip_idx % size)[1]);
            do{
                System.out.println(url1);
                data_zhi= getHistoryWithCode(url1, ippool.get(ip_idx % size)[0], Integer.parseInt(ippool.get(ip_idx % size)[1]));
            }while (data_zhi==null);
            if(data_zhi.size()==0){
                do{
                    System.out.println(url2);
                    data_zhi= getHistoryWithCode(url2, ippool.get(ip_idx % size)[0], Integer.parseInt(ippool.get(ip_idx % size)[1]));
                }while (data_zhi==null);
            }
            ip_idx++;
            String[] history_data = new String[12];
            ...
            LinkDataBase.addVals(history_zhi,"香港全览_不复权","Data","Ccode","Ctime","Cname","Ctype","Copen","Chigh","Clow","Cpreclose","Cvolume","Ctransactions","Mtype","IsGang");
            i++;
        }
    }
